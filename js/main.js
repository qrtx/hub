...
var configs = (function () {
    ...
    Singleton.defaultOptions = {
        general_help: "Список всех команд, которые вы можете использовать:",
        ls_help: "Список сведений о файлах и папках (по умолчанию текущий каталог).",
        cat_help: "Считать содержимое файлы (файлов) и выведите его на экран.",
        whoami_help: "Вывести имя пользователя, связанное с текущим действующим идентификатором пользователя, а так же дополнительную информацию.",
        date_help: "Вывести системную дату и время.",
        help_help: "Вывести это меню с подсказками",
        clear_help: "Очистить экран терминала.",
        reboot_help: "Перезагрузить систему",
        cd_help: "Сменить рабочую дерикторию.",
        mv_help: "Переместить файлы.",
        rm_help: "Удалить файлы.",
        rmdir_help: "Удалить дерикторю (команда работает когда папка/дериктория пустая).",
        touch_help: "Изменить временные метки файлов. Если файл не существует, он создается пустым.",
        sudo_help: "Выполните команду от имени администратора.",
        welcome: "ВЕДУТСЯ РАБОТЫ\n\n\nДобро пожаловать!\nОписание будет дополнено.\n\nДля дальнейшей навигации по системе введите команду, либо введите [help], либо используйте Tab\n",
        internet_explorer_warning: "ПРИМЕЧАНИЕ: Система обнаружила, что вы используете internet Explorer, этот веб-сайт может не отображаться/ не работать должным образом.",
        welcome_file_name: "info_msg.txt",
        invalid_command_message: "<value>: такой команды не существует.",
        reboot_message: "Попытка перезагрузки...\n\n3...\n\n2...\n\n1...\n\nУспешно...\n\n",
        permission_denied_message: "Невозможно выполнить '<value>', в доступе отказано.",
        sudo_message: "Невозможно получить права администратора используя ВебКлиент.",
        usage: "Используется",
        file: "файл",
        file_not_found: "Файл'<value>' не найден, проверьте правильность написания.",
        username: "Имя пользователя",
        hostname: "Домен",
        platform: "Платформа",
        accesible_cores: "Доступные ядра процессора",
        language: "Язык",
        value_token: "<value>",
        host: "qrtx.ru",
        user: "guest",
...
var files = (function () {
    ...
    Singleton.defaultOptions = {
        "about.txt": "Данный сайт - демонстрация работы обычного JS, CSS и HTML.\n\nЕсли Вами были обнаружены какие либо баги, пожалуйста свяжитесь со мной: qwertyxyry@gmail.com",
        "git.url": "https://github.com/qrtx?tab=repositories",
